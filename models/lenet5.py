...
class DealDateSet(Dataset):
    ...
    def __init__(self, x, y):
        ...
        self.data = torch.from_numpy(x.reshape(-1, 1, 32, 32)).float()
...
class LeNet5(nn.Module):
    ...
    def __init__(self,in_num, out_num):
        ...
        self.classifier = nn.Sequential(
            nn.Linear(int(in_num / 16 / 16) * 256, 1024),
            nn.ReLU(),
...
class LeNet(object):
    ...
    def __init__(self, in_num, out_num, batch_size, lr, epoch):
        ...
        self.net = LeNet5(in_num, out_num)
    ...
    def train(self, data, label, test_data, test_label, val_rate=0.3, mixup=False, a=0.2):
        ...
        optimizer = optim.Adam(self.net.parameters(), lr=self.lr, weight_decay=1e-5)  # L2 regularization
        optimizer1 = optim.SGD(self.net.parameters(), lr=self.lr, weight_decay=1e-5)
        self.net.cuda()
